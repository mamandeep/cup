    ...
    gradeTable
        .on('click', 'a.add', function(e) {
            ...
            $(gradeTemplate({key: numberRows++}))
                ...
                .fadeIn('fast');
            if(numberRows > 1) {
                var attri1 = 'input[name$="data[Education][0][applicant_id]"]';
                var attri2 = 'input[name$="data[Education][' + (numberRows - 1) +  '][applicant_id]"]';
        ...
        .on('click', 'a.remove', function(e) {
            ...
            userIdElem = $("[name='Education.0.applicant_id']");
